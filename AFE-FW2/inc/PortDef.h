/***********************************************************************************************//**
  ...
  Based on PIC18F14K22Port Definition and Assignment for AFE
...
#define ENABLE_TRANSMIT()   do { TRISB7 = 0; TRISC4 = 0; } while(0);
#define DISABLE_TRANSMIT()  do { TRISB7 = 1; TRISC4 = 1; } while(0);
